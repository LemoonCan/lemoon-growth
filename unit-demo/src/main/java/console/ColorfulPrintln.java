...
public class ColorfulPrintln {
    ...
    public static void main(String[] args) {
        for (int i = 1; i < 8; i++) {
            System.out.println("\033[3"+i+";0m"+"彩色字"+"\033[0m");
            System.out.println("\033[9"+i+";0m"+"彩色字"+"\033[0m");
        }
        for (int i = 1; i < 8; i++) {
            System.out.println("\033[4"+i+";0m"+"彩色背景"+"\033[0m");
        }

        System.out.println("\033[0m"+"无样式"+"\033[0m");
